...
Begin
  ...
  // Socraschenie
   ...
   if (resultNumerator mod 9 = 0) then   
        abbreviatedNumerator:=resultNumerator div 9;
        writeln (abbreviatedNumerator);
     if (resultDenominator mod 9= 0) then  
         abbreviatedDenominator:=resultDenominator div 9;
         writeln (abbreviatedDenominator);
  
   if (resultNumerator mod 8 = 0) then   
        abbreviatedNumerator:=resultNumerator div 8;
        writeln (abbreviatedNumerator);
     if (resultDenominator mod 8= 0) then  
         abbreviatedDenominator:=resultDenominator div 8;
         writeln (abbreviatedDenominator);
    
     if (resultNumerator mod 7 = 0) then   
        abbreviatedNumerator:=resultNumerator div 7;
        writeln (abbreviatedNumerator);
     if (resultDenominator mod 7= 0) then  
         abbreviatedDenominator:=resultDenominator div 7;
         writeln (abbreviatedDenominator);
    
    if (resultNumerator mod 6 = 0) then   
        abbreviatedNumerator:=resultNumerator div 6;
        writeln (abbreviatedNumerator);
     if (resultDenominator mod 6= 0) then  
         abbreviatedDenominator:=resultDenominator div 6;
         writeln (abbreviatedDenominator);
         
  
   if (resultNumerator mod 5 = 0) then   
        abbreviatedNumerator:=resultNumerator div 5;
        writeln (abbreviatedNumerator);
     if (resultDenominator mod 5= 0) then  
         abbreviatedDenominator:=resultDenominator div 5;
         writeln (abbreviatedDenominator);
